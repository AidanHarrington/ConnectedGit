...
public class firebaseScript : MonoBehaviour
{
    ...
    public IEnumerator downloadAndSaveGreenPieces()
    {
        string pathToSaveIn = Application.persistentDataPath;
        string[] greenPieces = new string[] { "gs://aidanharringtonunity.appspot.com/green/black_bishop.png",
            "gs://aidanharringtonunity.appspot.com/green/black_king.png",
            "gs://aidanharringtonunity.appspot.com/green/black_knight.png",
            "gs://aidanharringtonunity.appspot.com/green/black_pawn.png",
            "gs://aidanharringtonunity.appspot.com/green/black_queen.png",
            "gs://aidanharringtonunity.appspot.com/green/black_rook.png",
            "gs://aidanharringtonunity.appspot.com/green/white_bishop.png",
            "gs://aidanharringtonunity.appspot.com/green/white_king.png",
            "gs://aidanharringtonunity.appspot.com/green/white_knight.png",
            "gs://aidanharringtonunity.appspot.com/green/white_pawn.png",
            "gs://aidanharringtonunity.appspot.com/green/white_queen.png",
            "gs://aidanharringtonunity.appspot.com/green/white_rook.png",
            "gs://aidanharringtonunity.appspot.com/green/board.png"};
        
        foreach(var element in greenPieces)
        {
    ...
    public IEnumerator initFirebase(string path)
    {
        if (!signedin)
        {
            FirebaseApp.DefaultInstance.SetEditorDatabaseUrl("https://aidanharringtonunity.firebaseio.com/");
